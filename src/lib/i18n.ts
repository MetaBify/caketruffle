...
const translations = {
  en: {
    ...
    heroTitle: "Soft, modern recipes with a warm finish.",
    heroSubtitle:
      "Freshly curated dishes with clear steps, real measurements, and a cozy tone.",
  ...
  es: {
    ...
    heroTitle: "Recetas suaves y modernas con un final calido.",
    heroSubtitle:
      "Platos seleccionados con pasos claros, medidas reales y un tono acogedor.",
  ...
  ru: {
    ...
    heroTitle: "Myagkie sovremennye retsepty s teplym poslevkusiyem.",
    heroSubtitle:
      "Otobrannye blyuda s chetkimi shagami, realnymi merami i uyutnym tonom.",
